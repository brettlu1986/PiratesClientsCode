...
local SettingCameraDataTable = {}

SettingCameraDataTable.szFileName = "client/setting/setting_camera.tab"

function SettingCameraDataTable:OnEditorDefine(Parser)
    Parser:SetKey("nId")
...
-- [EXPORT BEGIN]
function SettingCameraDataTable:GetTemplate(nId)
    return self.tbContainer[nId] 
end
-- [EXPORT END]

return SettingCameraDataTable
