...
local UPDialogCommon1 = luaclass("UPDialogCommon1", PrefabBase)
local UIManager = require("UIManager")
local UISetUtils = require("UISetUtils")

local L10N_BTN_TEXT_CONFIRM = UISetUtils.GetL10NTextByKey("UPDIALOGCOMMON1_L10N_BTN_TEXT_CONFIRM")
local L10N_BTN_TEXT_CANCEL = UISetUtils.GetL10NTextByKey("UPDIALOGCOMMON1_L10N_BTN_TEXT_CANCEL")


UPDialogCommon1.pAnimCommonPop = nil
UPDialogCommon1.szBtnOKText = nil
UPDialogCommon1.szBtnCancelText = nil
UPDialogCommon1.funOK = nil
UPDialogCommon1.funCancel = nil
UPDialogCommon1.bIsOpen = false
UPDialogCommon1.szCurrentDialogType = nil    --挂接在通用弹窗预设上的窗口名称
UPDialogCommon1.bBtnCancelFullScreen = true
--按下cancel是否关闭界面
UPDialogCommon1.bCancelCloseUi = true
--动画播放完毕
UPDialogCommon1.funPlayAnimEnd = nil
...
function UPDialogCommon1:OnShow()
end

function UPDialogCommon1:OnLoad()
...
--事件绑定
function UPDialogCommon1:OnBindEvent()
...
--设置弹窗的公用控件
function UPDialogCommon1:SetDialogCommonData(szTitle,tbCommonBtnData)
...
--设置按钮是否变灰
-- function UPDialogCommon1:SetBtnIsEnabled(bEnabledOk, bEnabledCancel)
...
--隐藏弹窗公用按钮（确认和取消）
function UPDialogCommon1:HideCommonButton()
    self.pWidgetRef.cvsButton:SetVisibility(ESlateVisibility.Hidden)
end

--隐藏左侧的按钮
function UPDialogCommon1:HideLeftButton()
...
--显示弹窗公用按钮
function UPDialogCommon1:ShowCommonButton()
...
--响应对话框外 关闭按钮
function UPDialogCommon1:OnBtnCancelFullScreen()
    if self.bBtnCancelFullScreen then
        OnClickBtnCancel(self)
    end
end

return UPDialogCommon1
