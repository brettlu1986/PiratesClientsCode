...
local GuideSingleDataTable = {}

GuideSingleDataTable.szFileName = "client/guide/guide_single.tab"
-- GuideSingleDataTable.bEnableIterateKey = true
-- [EXPORT]
GuideSingleDataTable.tbModuleContainer = {}

function GuideSingleDataTable:OnEditorDefine(Parser)
...
function GuideSingleDataTable:OnEditorParseLine(Parser, tbContainer, tbNewTemplate)
...
function GuideSingleDataTable:OnEditorParseFinished()
    
end

-- [EXPORT BEGIN]
function GuideSingleDataTable:GetModuleGroups(nModuleId)
...
-- [EXPORT BEGIN]
function GuideSingleDataTable:GetGroupType(nModuleId, nGroupId)
...
-- [EXPORT BEGIN]
function GuideSingleDataTable:GetGroupIsInQueue(nModuleId, nGroupId)
    local tbModule = self.tbModuleContainer[nModuleId]
    if(tbModule == nil)then
        return false
    end
...
-- [EXPORT BEGIN]
function GuideSingleDataTable:GetModules(tbModuleAndGroup)
    local tbModuleContainer = self.tbModuleContainer
...
-- [EXPORT BEGIN]
function GuideSingleDataTable:GetAllModules()
    local tbModuleContainer = self.tbModuleContainer
    if not tbModuleContainer then
        return nil
    end
...
-- [EXPORT BEGIN]
function GuideSingleDataTable:GetAllSteps()
    return self.tbContainer
end
-- [EXPORT END]

return GuideSingleDataTable