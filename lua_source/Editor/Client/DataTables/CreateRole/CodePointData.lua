...
CodePointData.szFileName = "common/name/code_point.tab"


function CodePointData:OnEditorDefine(Parser)
...
function CodePointData:OnEditorParseLine(Parser, tbContainer, tbNewTemplate)
...
-- [EXPORT BEGIN]
function CodePointData:GetTemplate()
