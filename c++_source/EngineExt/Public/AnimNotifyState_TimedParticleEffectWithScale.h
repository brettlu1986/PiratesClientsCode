...
#include "AnimNotifyState_TimedParticleEffectWithScale.generated.h"
...
UCLASS(MinimalAPI, Blueprintable, meta = (DisplayName = "Timed Particle Effect With Scale"))
class UAnimNotifyState_TimedParticleEffectWithScale : public UAnimNotifyState
{
