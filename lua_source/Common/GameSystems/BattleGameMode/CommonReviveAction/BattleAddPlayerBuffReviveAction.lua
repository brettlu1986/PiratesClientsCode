-----------------------------------------------------
--File Name    : BattleAddPlayerBuffReviveAction.lua
--Author       : 
--Create Time  : 
...
local BattleAddPlayerBuffReviveAction = luaclass("BattleAddPlayerBuffReviveAction", BattleActionBase)

local BattleOperationHelper = require("BattleOperationHelper")
local BattleBlackboard = require("BattleBlackboard")
local BattleOperationDef = dynamic_require("BattleOperationDef")

BattleAddPlayerBuffReviveAction.nBuffId = nil
BattleAddPlayerBuffReviveAction.bRemoveBuff = nil
BattleAddPlayerBuffReviveAction.nOverlapCount = 0

function BattleAddPlayerBuffReviveAction:Parse(tbJsonData)
...
function BattleAddPlayerBuffReviveAction:Execute()
...
return BattleAddPlayerBuffReviveAction
