...
#include "AnimNotify_PlayParticleEffectWithScale.generated.h"

class UAnimSequenceBase;
class UParticleSystem;
class USkeletalMeshComponent;

UCLASS(const, hidecategories = Object, collapsecategories, meta = (DisplayName = "Play Particle Effect With Scale"))
class ENGINEEXT_API UAnimNotify_PlayParticleEffectWithScale : public UAnimNotify
{
	GENERATED_BODY()
