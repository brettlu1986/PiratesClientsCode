...
--]]
local BotInitItemRandomDataTable = {}

local BattleItemDataTable = require("BattleItemDataTable")

BotInitItemRandomDataTable.szFileName = "common/ffa/ai/bot/bot_init_item_random.tab"

function BotInitItemRandomDataTable:OnEditorDefine(Parser)
...
function BotInitItemRandomDataTable:OnEditorParseLine(Parser, tbContainer, tbNewTemplate)
...
-- [EXPORT BEGIN]
function BotInitItemRandomDataTable:GetRandomItems(nGroupId)
    local tbGroupTemplates = self.tbContainer[nGroupId]
    if tbGroupTemplates == nil then
        error("BotInitItemRandomDataTable:GetRandomItems failed, nGroupId:".. nGroupId)
    end
    local tbRandomItems = {}
...
return BotInitItemRandomDataTable
